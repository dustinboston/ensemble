...
export class Env {
     ...
     * @example new Env();
     */
    constructor(outerEnv = undefined, binds = [], exprs = []) {
        this.outer = outerEnv;
        this.binds = binds;
        this.exprs = exprs;
    ...
    serialize() {
        const serialized = types.createMapNode();
        let outer = types.createMapNode();
        if (this.outer) {
