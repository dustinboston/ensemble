...
export const arrayFunctions = [
    ...
    ['Array.prototype.unshift', arrayUnshift], // Prepend
...
export function arrayFrom(...args) {
...
export function arrayIsArray(...args) {
...
export function arrayConcat(...args) {
    types.assertMinimumArgumentCount(args.length, 1);
    types.assertSequentialValues(args, types.VectorNode);
    const result = args[0].value.concat(...args.slice(1).map((x) => x.value));
    return types.createVectorNode(result);
}
export function arrayCopyWithin(...args) {
...
export function arrayEntries(...args) {
    types.assertArgumentCount(args.length, 1);
    types.assertVectorNode(args[0]);
...
export function arrayEvery(...args) {
    types.assertArgumentCount(args.length, 2);
    types.assertVectorNode(args[0]);
    types.assertFunctionNode(args[1]);
    const vector = args[0].value;
...
export function arrayFill(...args) {
...
export function arrayFilter(...args) {
    types.assertArgumentCount(args.length, 2);
...
export function arrayFind(...args) {
    types.assertArgumentCount(args.length, 2);
    types.assertVectorNode(args[0]);
    types.assertFunctionNode(args[1]);
    const vector = args[0].value;
...
export function arrayFindIndex(...args) {
    types.assertArgumentCount(args.length, 2);
    types.assertVectorNode(args[0]);
    types.assertFunctionNode(args[1]);
    const vector = args[0].value;
...
export function arrayFindLast(...args) {
    types.assertArgumentCount(args.length, 2);
    types.assertVectorNode(args[0]);
    types.assertFunctionNode(args[1]);
    const vector = args[0].value;
...
export function arrayFindLastIndex(...args) {
    types.assertArgumentCount(args.length, 2);
    types.assertVectorNode(args[0]);
    types.assertFunctionNode(args[1]);
    const vector = args[0].value;
...
export function arrayFlat(...args) {
    types.assertArgumentCount(args.length, 1);
    types.assertVectorNode(args[0]);
    const vector = args[0].value;
...
export function arrayFlatMap(...args) {
    types.assertArgumentCount(args.length, 2);
    types.assertVectorNode(args[0]);
    types.assertFunctionNode(args[1]);
    const vector = args[0].value;
...
export function arrayIncludes(...args) {
    types.assertArgumentCount(args.length, 2);
...
export function arrayIndexOf(...args) {
    types.assertArgumentCount(args.length, 2);
    types.assertVectorNode(args[0]); // Assert the first argument *must* be a vector
    types.assertAstNode(args[1]); // The element can be any AstNode
    const vec = args[0];
...
export function arrayJoin(...args) {
...
export function arrayKeys(...args) {
    types.assertArgumentCount(args.length, 1);
    types.assertVectorNode(args[0]);
    const vec = args[0];
...
// pop
export function arrayLast(...args) {
    types.assertArgumentCount(args.length, 1);
    types.assertVectorNode(args[0]);
    const vec = args[0];
...
// push
export function arrayPush(...args) {
...
export function arrayLength(...args) {
    types.assertArgumentCount(args.length, 1);
    types.assertVectorNode(args[0]);
    const vec = args[0];
 ...
 */
export function arrayReduce(...args) {
...
export function arrayToReversed(...args) {
    types.assertArgumentCount(args.length, 1);
    types.assertVectorNode(args[0]);
    const vec = args[0];
...
export function arrayFirst(...args) {
    types.assertArgumentCount(args.length, 1);
    types.assertVectorNode(args[0]);
    const vec = args[0];
...
export function arraySlice(...args) {
    types.assertVariableArgumentCount(args.length, 1, 3);
    types.assertVectorNode(args[0]);
    let start = 0;
    if (args[1] !== undefined) {
...
export function arraySome(...args) {
    types.assertArgumentCount(args.length, 2);
    types.assertVectorNode(args[0]);
    types.assertFunctionNode(args[1]);
    const vector = args[0].value;
...
export function arrayToSorted(...args) {
    types.assertArgumentCount(args.length, 2);
    types.assertVectorNode(args[0]);
    types.assertFunctionNode(args[1]);
    const vector = args[0].value;
...
export function arrayToSpliced(...args) {
    types.assertVariableArgumentCount(args.length, 2, 4);
    types.assertVectorNode(args[0]);
    types.assertNumberNode(args[1]);
    const vector = args[0].value;
...
export function arrayReplaceWith(...args) {
    types.assertArgumentCount(args.length, 3);
    types.assertVectorNode(args[0]);
    types.assertNumberNode(args[1]);
    types.assertAstNode(args[2]);
