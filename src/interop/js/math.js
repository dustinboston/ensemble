...
export function mathAbs(...astArgs) {
...
export function mathAcos(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathAcosh(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathAsin(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathAsinh(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathAtan(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathAtan2(...astArgs) {
...
export function mathAtanh(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathCbrt(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathCeil(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathClz32(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathCos(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathCosh(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathExp(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathExpm1(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathFloor(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathFround(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathHypot(...astArgs) {
    types.assertSequentialValues(astArgs, types.NumberNode);
    const values = astArgs.map(types.unwrapNumberNode);
    const result = Math.hypot(...values);
    return types.toAst(result);
}
export function mathImul(...astArgs) {
    types.assertArgumentCount(astArgs.length, 2);
    types.assertNumberNode(astArgs[0]);
    types.assertNumberNode(astArgs[1]);
...
export function mathLog(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathLog10(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathLog1p(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathLog2(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathMax(...astArgs) {
    types.assertSequentialValues(astArgs, types.NumberNode);
    const values = astArgs.map(types.unwrapNumberNode);
    const result = Math.max(...values);
    return types.toAst(result);
}
export function mathMin(...astArgs) {
    types.assertSequentialValues(astArgs, types.NumberNode);
    const values = astArgs.map(types.unwrapNumberNode);
    const result = Math.min(...values);
    return types.toAst(result);
}
export function mathPow(...astArgs) {
...
export function mathRandom(...astArgs) {
    if ((astArgs.length === 0)) {
...
export function mathRound(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathSign(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathSin(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathSinh(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathSqrt(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathTan(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathTanh(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathTrunc(...astArgs) {
    types.assertArgumentCount(astArgs.length, 1);
    types.assertNumberNode(astArgs[0]);
    const x = astArgs[0].value;
...
export function mathLn10(...astArgs) {
    if ((astArgs.length === 0)) {
...
export function mathLn2(...astArgs) {
    if ((astArgs.length === 0)) {
...
export function mathLog10e(...astArgs) {
    if ((astArgs.length === 0)) {
...
export function mathLog23(...astArgs) {
    if ((astArgs.length === 0)) {
...
export function mathPi(...astArgs) {
    if ((astArgs.length === 0)) {
...
export function mathSqrt12(...astArgs) {
    if ((astArgs.length === 0)) {
...
export function mathSqrt2(...astArgs) {
    if ((astArgs.length === 0)) {
