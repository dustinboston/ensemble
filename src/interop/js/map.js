...
export function mapGetEntries(...astArgs) {
 ...
 */
export function mapDelete(...args) {
    types.assertMinimumArgumentCount(args.length, 1);
    types.assertMapNode(args[0]);
    const dict = types.createMapNode(new Map(args[0].value));
