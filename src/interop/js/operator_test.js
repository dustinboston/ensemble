...
// and
test('and', () => {
    assertEquals(operators.and(types.createBooleanNode(true), types.createBooleanNode(true)), types.createBooleanNode(true));
    assertEquals(operators.and(types.createBooleanNode(true), types.createBooleanNode(false)), types.createBooleanNode(false));
...
// decrement
test('decrement', () => {
    assertEquals(operators.decrement(types.createNumberNode(2)), types.createVectorNode([types.createNumberNode(1), types.createNumberNode(2)]));
    assertEquals(operators.decrement(types.createNumberNode(2), types.createStringNode('prefix')), types.createVectorNode([types.createNumberNode(1), types.createNumberNode(1)]));
    assertThrows(() => operators.decrement(types.createNumberNode(1), types.createStringNode('asdf')));
});
// increment
test('increment', () => {
    assertEquals(operators.increment(types.createNumberNode(1)), types.createVectorNode([types.createNumberNode(2), types.createNumberNode(1)]));
    assertEquals(operators.increment(types.createNumberNode(1), types.createStringNode('prefix')), types.createVectorNode([types.createNumberNode(2), types.createNumberNode(2)]));
...
// notEqualTo
test('notEqualTo', () => {
    assertEquals(operators.notEqualTo(types.createNumberNode(1), types.createNumberNode(1)), types.createBooleanNode(false));
    assertEquals(operators.notEqualTo(types.createNumberNode(1), types.createNumberNode(2)), types.createBooleanNode(true));
});
// nullishCoalesce
test('nullishCoalescing', () => {
    ...
    assertEquals(operators.nullishCoalesce(types.createNumberNode(1), types.createNumberNode(5)), types.createNumberNode(1));
});
// or
test('or', () => {
    assertEquals(operators.or(types.createBooleanNode(false), types.createBooleanNode(true)), types.createBooleanNode(true));
    assertEquals(operators.or(types.createBooleanNode(false), types.createBooleanNode(false)), types.createBooleanNode(false));
...
test('unsignedRightShift', () => {
    assertEquals(operators.unsignedRightShift(types.createNumberNode(5), types.createNumberNode(1)), types.createNumberNode(2));
