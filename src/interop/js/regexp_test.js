import { assert, assertEquals, assertThrows, test } from "../../../tests/test_runner.js";
import * as types from "../../types.js";
import * as fns from "./regexp.js";
...
test('regExpPrototypeTest: throws if first arg is not an AstNode', () => {
    ...
    assertThrows(() => {
        ...
        fns.testRegExp(regexp, stringValue);
    }, Error);
});
