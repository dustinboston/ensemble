...
export function newNumber(...astArgs) {
...
export function numberIsFinite(...astArgs) {
    if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        const value = astArgs[0].value;
...
export function numberIsInteger(...astArgs) {
    if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        const value = astArgs[0].value;
...
export function numberIsNaN(...astArgs) {
    if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        const value = astArgs[0].value;
...
export function numberIsSafeInteger(...astArgs) {
    if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        const value = astArgs[0].value;
...
export function numberParseFloat(...astArgs) {
...
export function numberParseInt(...astArgs) {
...
export function numberEpsilon(...astArgs) {
    if ((astArgs.length === 0)) {
...
export function numberMaxSafeInteger(...astArgs) {
    if ((astArgs.length === 0)) {
...
export function numberMaxValue(...astArgs) {
    if ((astArgs.length === 0)) {
...
export function numberMinSafeInteger(...astArgs) {
    if ((astArgs.length === 0)) {
...
export function numberMinValue(...astArgs) {
    if ((astArgs.length === 0)) {
...
export function numberNaN(...astArgs) {
    if ((astArgs.length === 0)) {
...
export function numberNegativeInfinity(...astArgs) {
    if ((astArgs.length === 0)) {
...
export function numberPositiveInfinity(...astArgs) {
    if ((astArgs.length === 0)) {
...
export function numberPrototypeToExponential(...astArgs) {
    types.assertVariableArgumentCount(astArgs.length, 1, 2);
...
export function numberPrototypeToFixed(...astArgs) {
    types.assertVariableArgumentCount(astArgs.length, 1, 2);
    types.assertNumberNode(astArgs[0]);
    if (astArgs.length === 2) {
        types.assertNumberNode(astArgs[1]);
...
export function numberPrototypeToPrecision(...astArgs) {
    types.assertVariableArgumentCount(astArgs.length, 1, 2);
    types.assertNumberNode(astArgs[0]);
    if (astArgs.length === 2) {
        types.assertNumberNode(astArgs[1]);
...
export function numberPrototypeToString(...astArgs) {
    types.assertVariableArgumentCount(astArgs.length, 1, 2);
    types.assertNumberNode(astArgs[0]);
    if (astArgs.length === 2) {
        types.assertNumberNode(astArgs[1]);
