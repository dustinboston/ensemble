...
test('mathAtan2: should return the arctangent of the quotient of its arguments', () => {
    assertEquals(mathFunctions.mathAtan2(types.createNumberNode(1), types.createNumberNode(1)), types.createNumberNode(Math.atan2(1, 1)));
});
...
test('mathMax: should return the largest of zero or more numbers', () => {
    assertEquals(mathFunctions.mathMax(types.createNumberNode(1), types.createNumberNode(5), types.createNumberNode(2)), types.createNumberNode(5));
});
...
test('mathHypot: should return the square root of the sum of squares of its arguments', () => {
    assertEquals(mathFunctions.mathHypot(types.createNumberNode(3), types.createNumberNode(4)), types.createNumberNode(5));
});
// mathImul
test('mathImul', () => {
    assertEquals(mathFunctions.mathImul(types.createNumberNode(3), types.createNumberNode(4)), types.createNumberNode(Math.imul(3, 4)));
});
// mathLn10
test('mathLn10', () => {
...
test('mathMin: should return the smallest of zero or more numbers', () => {
    assertEquals(mathFunctions.mathMin(types.createNumberNode(1), types.createNumberNode(5), types.createNumberNode(2)), types.createNumberNode(1));
});
// mathPow
