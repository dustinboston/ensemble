import { assert, assertEquals, assertInstanceOf, assertSpyCall, assertSpyCalls, assertStrictEquals, assertThrows, spy, test } from "../tests/test_runner.js";
import * as core from "./core.js";
import * as types from "./types.js";
test('eq(): returns true for equal nodes', () => {
    assertEquals(core.eq(types.createNumberNode(1), types.createNumberNode(1)), types.createBooleanNode(true));
});
test('eq(): returns false for unequal nodes', () => {
    assertEquals(core.eq(types.createNumberNode(1), types.createNumberNode(2)), types.createBooleanNode(false));
});
test('printEscapedString(): returns escaped string', () => {
    assertEquals(core.printEscapedString(types.createStringNode('abc\ndef\nghi')), types.createStringNode('"abc\\ndef\\nghi"'));
});
test('printUnescapedString(): returns unescaped string', () => {
    assertEquals(core.printUnescapedString(types.createStringNode('abc\ndef\nghi')), types.createStringNode('abc\ndef\nghi'));
});
test('printEscapedStringToScreen(): logs the escaped string', () => {
    const logSpy = spy(console, 'log');
    try {
        assertEquals(core.printEscapedStringToScreen(types.createStringNode('abc\ndef\nghi')), types.createNilNode());
    }
    finally {
        logSpy.restore();
    }
...
test('printEscapedStringToScreen(): logs the unescaped string', () => {
    const logSpy = spy(console, 'log');
    try {
        assertEquals(core.printUnescapedStringToScreen(types.createStringNode('abc\ndef\nghi')), types.createNilNode());
    }
    finally {
        logSpy.restore();
    }
...
test('readString(): throws when there is more than one argument', () => {
    assertThrows(() => core.readString(types.createStringNode('foo'), types.createStringNode('bar')));
});
...
test('trim(): should trim whitespace from the start and end of a string', () => {
    assertEquals(core.trim(types.createStringNode('  hello  ')), types.createStringNode('hello'));
});
...
test('trim(): should throw an error when more than one argument is provided', () => {
    assertThrows(() => {
        core.trim(types.createStringNode('hello'), types.createStringNode('world'));
    });
});
...
test("lte(): should return false if 'a' is greater than 'b'", () => {
    const result1 = core.lte(types.createNumberNode(2), types.createNumberNode(1));
    assertEquals(result1, types.createBooleanNode(false));
});
test("lte(): should return true if 'a' is equal to 'b'", () => {
    const result2 = core.lte(types.createNumberNode(1), types.createNumberNode(1));
    assertEquals(result2, types.createBooleanNode(true));
});
test("lte(): should return true if 'a' is less than 'b'", () => {
    const result2 = core.lte(types.createNumberNode(1), types.createNumberNode(2));
    assertEquals(result2, types.createBooleanNode(true));
});
// Test for '>'
...
test("gte(): should return true if 'a' is greater than 'b'", () => {
    const result1 = core.gte(types.createNumberNode(2), types.createNumberNode(1));
    assertEquals(result1, types.createBooleanNode(true));
});
test("gte(): should return true if 'a' is equal to 'b'", () => {
    const result2 = core.gte(types.createNumberNode(1), types.createNumberNode(1));
    assertEquals(result2, types.createBooleanNode(true));
});
// Test for '+'
...
test('conj(): should throw with with less than 2 arguments', () => {
    assertThrows(() => core.conj(types.createListNode([types.createNumberNode(1)])), Error, 'Unexpected minimum number of arguments');
});
test('conj(): should conjoin values in a list', () => {
    assertEquals(core.conj(types.createListNode([
        types.createNumberNode(1),
        types.createNumberNode(2),
        types.createNumberNode(3),
    ]), types.createNumberNode(4), types.createNumberNode(5)), types.createListNode([
...
test('conj(): should conjoin values in a vector', () => {
    assertEquals(core.conj(types.createVectorNode([
        types.createNumberNode(1),
        types.createNumberNode(2),
        types.createNumberNode(3),
    ]), types.createNumberNode(4), types.createNumberNode(5)), types.createVectorNode([
        types.createNumberNode(1),
        types.createNumberNode(2),
        types.createNumberNode(3),
        types.createNumberNode(4),
...
test('conj(): should throw without a List or Vector', () => {
    assertThrows(() => core.conj(types.createNumberNode(42), types.createNumberNode(1)), Error, 'Invalid sequential type');
});
...
test('concat(): with non-Seq type should throw', () => {
    assertThrows(() => core.concat(types.createNumberNode(1)), Error, 'Invalid sequential type');
});
test('cons(): should construct a list by prepending the given value', () => {
    assertEquals(core.cons(types.createNumberNode(0), types.createListNode([
        types.createNumberNode(1),
        types.createNumberNode(2),
        types.createNumberNode(3),
    ])), types.createListNode([
...
test('cons(): should throw error with less than 2 arguments', () => {
    assertThrows(() => core.cons(types.createNumberNode(0)), Error, 'Wanted 2 arguments but got 1');
});
test('cons(): should throw error with more than 2 arguments', () => {
    assertThrows(() => core.cons(types.createNumberNode(0), types.createNumberNode(0), types.createNumberNode(0)), Error, 'Wanted 2 arguments but got 3');
});
test('cons(): should throw error if second argument is not a List', () => {
    ...
    assertThrows(() => core.cons(value, notList), Error, 'Invalid sequential type');
});
// Test for 'vec' when input is a list
test('vec(): should convert a list into a vector', () => {
    assertEquals(core.vec(types.createListNode([
        types.createNumberNode(1),
        types.createNumberNode(2),
        types.createNumberNode(3),
...
test('vec(): should ignore additional arguments', () => {
    assertEquals(core.vec(types.createListNode([types.createNumberNode(1)]), types.createNumberNode(2)), types.createVectorNode([types.createNumberNode(1)]));
});
...
test('nth(): should return the nth element of a list', () => {
    assertEquals(core.nth(types.createListNode([
        types.createSymbolNode('a'),
        types.createSymbolNode('b'),
        types.createSymbolNode('c'),
    ]), types.createNumberNode(1)), types.createSymbolNode('b'));
});
test('nth(): should throw error when index is out of range', () => {
    assertThrows(() => core.nth(types.createListNode([types.createSymbolNode('a')]), types.createNumberNode(1)), Error, 'out of range');
});
test('firstNodeInList(): should return the first element of a list', () => {
    assertEquals(core.firstNodeInList(types.createListNode([
        types.createSymbolNode('a'),
        types.createSymbolNode('b'),
    ])), types.createSymbolNode('a'));
});
test('firstNodeInList(): should return nil for empty list', () => {
    assertEquals(core.firstNodeInList(types.createListNode([])), types.createNilNode());
});
test('rest(): should return a list without the first element', () => {
    assertEquals(core.rest(types.createListNode([
        types.createNumberNode(1),
        types.createNumberNode(2),
        types.createNumberNode(3),
    ])), types.createListNode([
...
test('rest(): should return empty list for single-element list', () => {
    assertEquals(core.rest(types.createListNode([types.createNumberNode(1)])), types.createListNode([]));
});
...
test('empty(): should return false for a non-empty list', () => {
    assertEquals(core.empty(types.createListNode([types.createNumberNode(2)])), types.createBooleanNode(false));
});
test('count(): should return the length of a list', () => {
    assertEquals(core.length(types.createListNode([
        types.createNumberNode(1),
        types.createNumberNode(2),
    ])), types.createNumberNode(2));
});
...
test('atom(): should create an Atom from a given node', () => {
    assertEquals(core.atom(types.createNumberNode(42)), types.createAtomNode(types.createNumberNode(42)));
});
test('atom(): should throw error when no arguments are provided', () => {
    assertThrows(() => core.atom(), Error, 'Wanted 1 arguments but got 0');
});
test('isAtom(): should return true if the node is an Atom', () => {
    assertEquals(core.isAtom(types.createAtomNode(types.createNumberNode(42))), types.createBooleanNode(true));
});
...
test('reset(): should throw error for non-Atom first argument', () => {
    assertThrows(() => core.reset(types.createNumberNode(42), types.createNumberNode(43)), Error, 'Invalid');
});
...
test('swap(): should throw an error if the first argument is not an Atom', () => {
    assertThrows(() => {
        core.swap(types.createStringNode('not an atom'), types.createFunctionNode((a) => a));
    });
});
test('swap(): should throw an error if the second argument is not a Func', () => {
    assertThrows(() => {
        core.swap(types.createAtomNode(types.createStringNode('a')), types.createStringNode('not a function'));
    });
});
test("swap(): should swap the Atoms' value with the result of the function", () => {
    assertEquals(core.swap(types.createAtomNode(types.createNumberNode(6)), types.createFunctionNode((a) => types.createNumberNode(a.value * 2))), types.createNumberNode(12));
});
test('swap(): should handle additional parameters correctly', () => {
    assertEquals(core.swap(types.createAtomNode(types.createNumberNode(5)), types.createFunctionNode((a, b) => types.createNumberNode(a.value +
        b.value)), types.createNumberNode(7)), types.createNumberNode(12));
});
...
test('throwError(): should throw an error when no arguments are provided', () => {
    assertThrows(() => core.throwError(), 'Unexpected number of arguments');
});
test('throwError(): should throw an error when given an invalid argument type', () => {
    assertThrows(() => core.throwError(types.createBooleanNode(false)), 'invalid argument');
});
test('apply(): should call a function with list arguments', () => {
    assertEquals(core.apply(types.createFunctionNode((a, b) => types.createNumberNode(a.value +
        b.value)), types.createListNode([
        types.createNumberNode(2),
        types.createNumberNode(3),
    ])), types.createNumberNode(5));
});
test('apply(): should concatenate other arguments with list', () => {
    assertEquals(core.apply(types.createFunctionNode((a, b, c) => types.createNumberNode(a.value +
        b.value +
        c.value)), types.createNumberNode(3), types.createListNode([
        types.createNumberNode(2),
        types.createNumberNode(1),
    ])), types.createNumberNode(6));
});
test('apply(): should throw error for non-Seq last argument', () => {
    assertThrows(() => core.apply(types.createFunctionNode((a, b) => types.createNumberNode(a.value +
        b.value)), types.createNumberNode(3)), Error, 'Invalid sequential type');
});
test('apply(): should throw error for non-Func first argument', () => {
    assertThrows(() => core.apply(types.createNumberNode(42), types.createListNode([
        types.createNumberNode(2),
        types.createNumberNode(3),
    ])), Error, 'Invalid');
});
test('applyToSequence(): should call function against each item in a list', () => {
    assertEquals(core.applyToSequence(types.createFunctionNode(function double(x) {
        return types.createNumberNode(x.value * 2);
    }), types.createListNode([
        types.createNumberNode(1),
        types.createNumberNode(2),
        types.createNumberNode(3),
...
test('applyToSequence(): should throw error if not given exactly 2 arguments', () => {
    assertThrows(() => core.applyToSequence(types.createFunctionNode(function double(x) {
        return types.createNumberNode(x.value * 2);
    })), Error, 'Wanted 2 arguments but got 1');
});
test('applyToSequence(): should throw error if second argument is not a List', () => {
    assertThrows(() => core.applyToSequence(types.createFunctionNode(function double(x) {
        return types.createNumberNode(x.value * 2);
    }), types.createNumberNode(42)), Error, 'Invalid sequential type');
});
...
test('seq(): should return a list if given a vec', () => {
    assertEquals(core.seq(types.createVectorNode([
        types.createNumberNode(1),
        types.createNumberNode(2),
        types.createNumberNode(3),
    ])), types.createListNode([
...
test('seq(): should return a list of chars if given a string', () => {
    assertEquals(core.seq(types.createStringNode('foo')), types.createListNode([
...
test('seq(): should return nil if given nil', () => {
    assertEquals(core.seq(types.createNilNode()), types.createNilNode());
});
test('seq(): should return nil if given an empty list', () => {
    assertEquals(core.seq(types.createListNode([])), types.createNilNode());
});
test('seq(): should return nil if given an empty vector', () => {
    assertEquals(core.seq(types.createVectorNode([])), types.createNilNode());
});
test('meta(): should return metadata of an element', () => {
    assertEquals(core.meta(types.createFunctionNode((x) => x, // Function
    undefined, // closureMeta
    false, // isMacro
    types.createMapNode(new Map([['b', types.createNumberNode(1)]])))), types.createMapNode(new Map([['b', types.createNumberNode(1)]])));
});
test('meta(): should throw error if not given exactly 1 argument', () => {
    assertThrows(() => core.meta(), Error, 'Wanted 1 arguments but got 0');
});
test("meta(): should throw error if argument isn't a MetadataType", () => {
    const notMetadataType = types.createNumberNode(42);
    assertThrows(() => core.meta(notMetadataType), Error, 'Invalid metadata type');
});
test('withMeta(): should set metadata', () => {
    ...
    const updated = core.withMeta(func, meta);
    assertEquals(updated.metadata, meta);
    assertEquals(func.metadata, undefined);
});
test('withMeta(): should throw error if not given exactly 2 arguments', () => {
    assertThrows(() => core.withMeta(), Error, 'Wanted 2 arguments but got 0');
});
test("withMeta(): should throw if first argument isn't MetadataType", () => {
    assertThrows(() => core.withMeta(types.createNumberNode(42), types.createMapNode(new Map([['b', types.createNumberNode(1)]]))), Error, 'Invalid metadata type');
});
test('isNil(): should return true if argument is a NilNode', () => {
    assertEquals(core.isNil(types.createNilNode()), types.createBooleanNode(true));
});
test('isNil(): should return false if argument is not a NilNode', () => {
    assertEquals(core.isNil(types.createBooleanNode(true)), types.createBooleanNode(false));
});
test('isTrue(): should return true for a true value', () => {
    assertEquals(core.isTrue(types.createBooleanNode(true)), types.createBooleanNode(true));
});
test('isTrue(): should return false for a false value', () => {
    assertEquals(core.isTrue(types.createBooleanNode(false)), types.createBooleanNode(false));
});
test('isFalse(): should return true for a false value', () => {
    assertEquals(core.isFalse(types.createBooleanNode(false)), types.createBooleanNode(true));
});
test('isFalse(): should return false for a true value', () => {
    assertEquals(core.isFalse(types.createBooleanNode(true)), types.createBooleanNode(false));
});
test('isString(): should return true if argument is a StringNode', () => {
    assertEquals(core.isString(types.createStringNode('foobar')), types.createBooleanNode(true));
});
test('isString(): should return false if argument is not a StringNode', () => {
    assertEquals(core.isString(types.createBooleanNode(true)), types.createBooleanNode(false));
});
...
test('isSymbol(): should return true if argument is a SymbolNode', () => {
    assertEquals(types.isSymbolNode(types.createSymbolNode('abc')), true);
});
test('isSymbol(): should return false if argument is not a SymbolNode', () => {
    assertEquals(types.isSymbolNode(types.createStringNode('abc')), false);
});
...
test('isKeyword(): should return true if argument is a KeywordNode', () => {
    assertEquals(core.isKeyword(types.createKeywordNode('abc')), types.createBooleanNode(true));
});
test('isKeyword(): should return false if argument is not a KeywordNode', () => {
    assertEquals(core.isKeyword(types.createSymbolNode('abc')), types.createBooleanNode(false));
});
test('isNumber(): should return true if argument is a NumberNode', () => {
    assertEquals(core.isNumber(types.createNumberNode(2)), types.createBooleanNode(true));
});
test('isNumber(): should return false if argument is not a NumberNode', () => {
    assertEquals(core.isNumber(types.createStringNode('2')), types.createBooleanNode(false));
});
...
test('isFn(): should return false if argument is not a FunctionNode', () => {
    assertEquals(core.isFn(types.createNumberNode(2)), types.createBooleanNode(false));
});
...
test('isMacro(): should return false if argument is not a macro', () => {
    assertEquals(core.isMacro(types.createNumberNode(2)), types.createBooleanNode(false));
});
test('vector(): should create a vector from args', () => {
    assertEquals(core.vector(types.createNumberNode(1), types.createNumberNode(2), types.createNumberNode(3)), types.createVectorNode([
        types.createNumberNode(1),
        types.createNumberNode(2),
        types.createNumberNode(3),
    ]));
...
test('isVector(): should return true if argument is a VectorNode', () => {
    assertEquals(core.isVector(types.createVectorNode([
        types.createNumberNode(1),
        types.createNumberNode(2),
        types.createNumberNode(3),
...
test('isVector(): should return false if argument is not a VectorNode', () => {
    assertEquals(core.isVector(types.createNumberNode(2)), types.createBooleanNode(false));
});
// Hash-map
test('hashMap(): should create a map from alternating args', () => {
    assertEquals(core.hashMap(types.createStringNode('foo'), types.createNumberNode(1), types.createStringNode('bar'), types.createNumberNode(2)), types.createMapNode(new Map([
...
test('isMap(): should return true if argument is a MapNode', () => {
    assertEquals(core.isMap(types.createMapNode(new Map([['foo', types.createNumberNode(1)]]))), types.createBooleanNode(true));
});
test('isMap(): should return false if argument is not a MapNode', () => {
    assertEquals(core.isMap(types.createNumberNode(2)), types.createBooleanNode(false));
});
test('assoc(): should merge key/value pairs into a map', () => {
    assertEquals(core.assoc(core.hashMap(types.createStringNode('foo'), types.createNumberNode(1)), types.createStringNode('bar'), types.createNumberNode(2)), core.hashMap(types.createStringNode('foo'), types.createNumberNode(1), types.createStringNode('bar'), types.createNumberNode(2)));
});
test('dissoc(): should remove elements from a dict', () => {
    assertEquals(core.dissoc(core.hashMap(types.createStringNode('foo'), types.createNumberNode(1), types.createStringNode('bar'), types.createNumberNode(2)), types.createStringNode('foo')), core.hashMap(types.createStringNode('bar'), types.createNumberNode(2)));
});
test('get(): should get a value from a map using a key', () => {
    assertEquals(core.get(core.hashMap(types.createKeywordNode('foo:'), types.createNumberNode(1), types.createKeywordNode('bar:'), types.createNumberNode(2)), types.createKeywordNode('bar:')), types.createNumberNode(2));
});
test('get(): should return nil if key does not exist', () => {
    assertEquals(core.get(core.hashMap(types.createKeywordNode('foo:'), types.createNumberNode(1), types.createKeywordNode('bar:'), types.createNumberNode(2)), types.createKeywordNode('baz:')), types.createNilNode());
});
test('get(): should return nil for invalid maps', () => {
    assertEquals(core.get(types.createStringNode('sharks'), types.createKeywordNode('surfers')), types.createNilNode());
});
test('contains(): should return true if key exists', () => {
    assertEquals(core.contains(core.hashMap(types.createKeywordNode('foo:'), types.createNumberNode(1), types.createKeywordNode('bar:'), types.createNumberNode(2)), types.createKeywordNode('bar:')), types.createBooleanNode(true));
});
test('contains(): should return false if key does not exist', () => {
    assertEquals(core.contains(core.hashMap(types.createKeywordNode('foo:'), types.createNumberNode(1), types.createKeywordNode('bar:'), types.createNumberNode(2)), types.createKeywordNode('baz:')), types.createBooleanNode(false));
});
test('keys(): should return a list of all keys in the map', () => {
    assertEquals(core.keys(core.hashMap(types.createKeywordNode('foo:'), types.createNumberNode(1), types.createKeywordNode('bar:'), types.createNumberNode(2))), types.createListNode([
        types.createKeywordNode('foo:'),
        types.createKeywordNode('bar:'),
    ]));
});
test('vals(): should return a list of all values in the map', () => {
    assertEquals(core.vals(core.hashMap(types.createKeywordNode('foo:'), types.createNumberNode(1), types.createKeywordNode('bar:'), types.createNumberNode(2))), types.createListNode([
        types.createNumberNode(1),
        types.createNumberNode(2),
    ]));
});
test('isSequential(): should return true for lists', () => {
    assertEquals(types.isSequentialNode(types.createListNode([
        types.createNumberNode(1),
        types.createNumberNode(2),
        types.createNumberNode(3),
    ])), true);
...
test('isSequential(): should return true for vectors', () => {
    assertEquals(types.isSequentialNode(types.createVectorNode([
        types.createNumberNode(4),
        types.createNumberNode(5),
        types.createNumberNode(6),
    ])), true);
...
test('join(): should concatenate elements with the default delimiter (spaces)', () => {
    assertEquals(core.join(types.createListNode([
        types.createNumberNode(1),
        types.createNumberNode(2),
...
test('join(): should concatenate elements with the given delimiter', () => {
    assertEquals(core.join(types.createListNode([
        ...
        types.createNumberNode(2),
        types.createStringNode('three'),
    ]), types.createStringNode(', ')), types.createStringNode('1, 2, three'));
});
