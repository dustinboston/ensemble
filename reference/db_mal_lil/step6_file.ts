/**
 * @file Step 6 adds string/file core functions including read-string, slurp,
 * and load-file. It also defines atom, atom?, deref, reset!, and swap! eval is
 * added to the environment as well as *ARGV*.
 */
