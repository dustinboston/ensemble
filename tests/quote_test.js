...
import { BooleanNode, ListNode, MapNode, NilNode, NumberNode, StringNode, SymbolNode, VectorNode, } from "../src/types.js";
...
test(`QUOTE: Testing regular quote`, () => {
    ...
    test(`QUOTE: quote returns a nested list of numbers`, () => {
        assertEquals(rep(`(quote (1 2 (3 4)))`, sharedEnv), 
        // (1 2 (3 4))
        printString(new ListNode([
            new NumberNode(1),
            new NumberNode(2),
...
test(`QUOTE: Testing simple quasiquote`, () => {
    ...
    test(`QUOTE: quasiquote returns nil`, () => {
        assertEquals(rep(`(quasiquote nil)`, sharedEnv), 
        // nil
        printString(new NilNode(), true));
    });
    test(`QUOTE: quasiquote returns 7`, () => {
        assertEquals(rep(`(quasiquote 7)`, sharedEnv), 
        // 7
        printString(new NumberNode(7), true));
    });
    test(`QUOTE: quasiquote returns a symbol`, () => {
        assertEquals(rep(`(quasiquote a)`, sharedEnv), 
        // a
        printString(new SymbolNode('a'), true));
    });
    test(`QUOTE: returns a map`, () => {
        assertEquals(rep(`(quasiquote {"a" b})`, sharedEnv), 
        // {"a" b}
        printString(new MapNode(new Map([
            ['"a"', new SymbolNode('b')],
        ])), true));
    });
});
test(`QUOTE: Testing quasiquote with lists`, () => {
    ...
    test(`QUOTE: quasiquote returns an empty list`, () => {
        assertEquals(rep(`(quasiquote ())`, sharedEnv), 
        // ()
        printString(new ListNode([]), true));
    });
    test(`QUOTE: quasiquote returns a list`, () => {
        assertEquals(rep(`(quasiquote (1 2 3))`, sharedEnv), 
        // (1 2 3)
        printString(new ListNode([
            new NumberNode(1),
            new NumberNode(2),
    ...
    test(`QUOTE: quasiquote return a nested list of numbers`, () => {
        assertEquals(rep(`(quasiquote (1 2 (3 4)))`, sharedEnv), 
        // (1 2 (3 4))
        printString(new ListNode([
            new NumberNode(1),
            new NumberNode(2),
    ...
    test(`QUOTE: quasiquote returns numbers and empty lists`, () => {
        assertEquals(rep(`(quasiquote (1 ()))`, sharedEnv), 
        // (1 ())
        printString(new ListNode([
            new NumberNode(1),
            new ListNode([]),
    ...
    test(`QUOTE: quasiquote will return empty lists whereever they occur`, () => {
        assertEquals(rep(`(quasiquote (1 () 2))`, sharedEnv), 
        // (1 () 2)
        printString(new ListNode([
            new NumberNode(1),
            new ListNode([]),
...
test(`QUOTE: Testing unquote`, () => {
    ...
    test(`QUOTE: unquote returns a number that has been quasiquoted`, () => {
        assertEquals(rep(`(quasiquote (unquote 7))`, sharedEnv), 
        // 7
        printString(new NumberNode(7), true));
    });
    ...
    test(`QUOTE: unquoting a symbol allows the symbol to be evaluated`, () => {
        assertEquals(rep(`(quasiquote (unquote a))`, sharedEnv), 
        // 8
        printString(new NumberNode(8), true));
    });
    test(`QUOTE: quasiquote prevents the symbol from being evaluated`, () => {
        assertEquals(rep(`(quasiquote (1 a 3))`, sharedEnv), 
        // (1 a 3)
        printString(new ListNode([
            new NumberNode(1),
            new SymbolNode('a'),
    ...
    test(`QUOTE: unquote allows the symbol to be evaluated`, () => {
        assertEquals(rep(`(quasiquote (1 (unquote a) 3))`, sharedEnv), 
        // (1 8 3)
        printString(new ListNode([
            new NumberNode(1),
            new NumberNode(8),
    ...
    test(`QUOTE: define a symbol with a quoted list for testing`, () => {
        assertEquals(rep('(def! b (quote (1 "b" "d")))', sharedEnv), 
        // (1 "b" "d")
        printString(new ListNode([
            new NumberNode(1),
            new StringNode('b'),
    ...
    test(`QUOTE: quasiquote prevents variables from being evaluated`, () => {
        assertEquals(rep(`(quasiquote (1 b 3))`, sharedEnv), 
        // (1 b 3)
        printString(new ListNode([
            new NumberNode(1),
            new SymbolNode('b'),
    ...
    test(`QUOTE: unquote allows variables to be evaluated in a nested list`, () => {
        assertEquals(rep(`(quasiquote (1 (unquote b) 3))`, sharedEnv), 
        // (1 (1 "b" "d") 3)
        printString(new ListNode([
            new NumberNode(1),
            new ListNode([
    ...
    test(`QUOTE: unquoting has the effect of combining nested lists`, () => {
        assertEquals(rep(`(quasiquote ((unquote 1) (unquote 2)))`, sharedEnv), 
        // (1 2)
        printString(new ListNode([
            new NumberNode(1),
            new NumberNode(2),
...
test(`QUOTE: Quasiquote and environments`, () => {
    ...
    test(`QUOTE: unquote works with a variable defined with let*`, () => {
        assertEquals(rep(`(let* (x 0) (quasiquote (unquote x)))`, sharedEnv), 
        // 0
...
test(`QUOTE: Testing splice-unquote`, () => {
    ...
    test(`QUOTE: define a symbol, "c", with a quoted list for testing`, () => {
        assertEquals(rep('(def! c (quote (1 "b" "d")))', sharedEnv), 
        // (1 "b" "d")
        printString(new ListNode([
            new NumberNode(1),
            new StringNode('b'),
    ...
    test(`QUOTE: quasiquote returns a list without evaluating symbols`, () => {
        assertEquals(rep(`(quasiquote (1 c 3))`, sharedEnv), 
        // (1 c 3)
        printString(new ListNode([
            new NumberNode(1),
            new SymbolNode('c'),
    ...
    test(`QUOTE: splice-unquote injects a symbol in place after evaluation`, () => {
        assertEquals(rep(`(quasiquote (1 (splice-unquote c) 3))`, sharedEnv), 
        // (1 1 "b" "d" 3)
        printString(new ListNode([
            new NumberNode(1),
            new NumberNode(1),
    ...
    test(`QUOTE: splice-unquotes works as the last item in a list`, () => {
        assertEquals(rep(`(quasiquote (1 (splice-unquote c)))`, sharedEnv), 
        // (1 1 "b" "d")
        printString(new ListNode([
            new NumberNode(1),
            new NumberNode(1),
    ...
    test(`QUOTE: splice-unquote works at the beginning of a list`, () => {
        assertEquals(rep(`(quasiquote ((splice-unquote c) 2))`, sharedEnv), 
        // (1 "b" "d" 2)
        printString(new ListNode([
            new NumberNode(1),
            new StringNode('b'),
    ...
    test(`QUOTE: splice-unquote can reuse symbols`, () => {
        assertEquals(rep(`(quasiquote ((splice-unquote c) (splice-unquote c)))`, sharedEnv), 
        // (1 "b" "d" 1 "b" "d")
        printString(new ListNode([
            new NumberNode(1),
            new StringNode('b'),
...
test(`QUOTE: Test quine`, () => {
    ...
    test(`QUOTE: You can make your brain explode by creating a quine with lots of quoting`, () => {
        assertEquals(rep(`((fn* (q) (quasiquote ((unquote q) (quote (unquote q))))) (quote (fn* (q) (quasiquote ((unquote q) (quote (unquote q)))))))`, sharedEnv), 
...
test(`QUOTE: Testing quasiquote with vectors`, () => {
    ...
    test(`QUOTE: quasiquote returns a vector with lots of nested vectors`, () => {
        assertEquals(rep(`(quasiquote [a [] b [c] d [e f] g])`, sharedEnv), 
        // [a [] b [c] d [e f] g]
        printString(new VectorNode([
            new SymbolNode('a'),
            new VectorNode([]),
...
test(`QUOTE: Misplaced unquote or splice-unquote`, () => {
    ...
    test(`QUOTE: unquote does nothing as the last argument`, () => {
        assertEquals(rep('`(0 unquote)', sharedEnv), 
        // (0 unquote)
        printString(new ListNode([
            new NumberNode(0),
            new SymbolNode('unquote'),
    ...
    test(`QUOTE: splice-unquote does nothing as the last argument`, () => {
        assertEquals(rep('`(0 splice-unquote)', sharedEnv), 
        // (0 splice-unquote)
        printString(new ListNode([
            new NumberNode(0),
    ...
    test(`QUOTE: unquote is not evaluated within a quasi-quoted vector`, () => {
        assertEquals(rep('`[unquote 0]', sharedEnv), 
        // [unquote 0]
        printString(new VectorNode([
            new SymbolNode('unquote'),
            new NumberNode(0),
    ...
    test(`QUOTE: splice-unquote is not evaluated within a quasi-quoted vector`, () => {
        assertEquals(rep('`[splice-unquote 0]', sharedEnv), 
        // [splice-unquote 0]
        printString(new VectorNode([
            new SymbolNode('splice-unquote'),
            new NumberNode(0),
...
test(`QUOTE: Debugging quasiquote`, () => {
    ...
    test(`QUOTE: quasiquoteexpand returns nil as-is`, () => {
        assertEquals(rep(`(quasiquoteexpand nil)`, sharedEnv), 
        // nil
        printString(new NilNode(), true));
    });
    test(`QUOTE: quasiquoteexpand returns a number as-is`, () => {
        assertEquals(rep(`(quasiquoteexpand 7)`, sharedEnv), 
        // 7
        printString(new NumberNode(7), true));
    });
    test(`QUOTE: quasiquoteexpand expands an expression without evaluating a symbol`, () => {
        assertEquals(rep(`(quasiquoteexpand a)`, sharedEnv), 
        // (quote a)
        printString(new ListNode([
            new SymbolNode('quote'),
            new SymbolNode('a'),
    ...
    test(`QUOTE: quasiquoteexpand expands a map without evaluating a symbol`, () => {
        assertEquals(rep(`(quasiquoteexpand {"a" b})`, sharedEnv), 
        // (quote {"a" b})
        printString(new ListNode([
            new SymbolNode('quote'),
            new MapNode(new Map([
    ...
    test(`QUOTE: quasiquoteexpand expands an empty list as-is`, () => {
        assertEquals(rep(`(quasiquoteexpand ())`, sharedEnv), 
        // ()
        printString(new ListNode([]), true));
    });
    test(`QUOTE: quasiquoteexpand expands a list of numbers to conses`, () => {
        assertEquals(rep(`(quasiquoteexpand (1 2 3))`, sharedEnv), 
    ...
    test(`QUOTE: quasiquoteexpand expands a list of lists nested conses`, () => {
        assertEquals(rep(`(quasiquoteexpand (1 2 (3 4)))`, sharedEnv), 
    ...
    test(`QUOTE: quasiquoteexpand expands numbers and empty lists to conses, switching the order`, () => {
        assertEquals(rep(`(quasiquoteexpand (1 ()))`, sharedEnv), 
        // (cons 1 (cons () ()))
        printString(new ListNode([
            new SymbolNode('cons'),
            new NumberNode(1),
    ...
    test(`QUOTE: quasiquoteexpand expands a list of numbers and and empty lists into conses`, () => {
        assertEquals(rep(`(quasiquoteexpand (1 () 2))`, sharedEnv), 
        // (cons 1 (cons () (cons 2 ())))
        printString(new ListNode([
            new SymbolNode('cons'),
            new NumberNode(1),
    ...
    test(`QUOTE: quasiquoteexpand quotes and conses many symbols and nested lists`, () => {
        assertEquals(rep(`(quasiquoteexpand (f () g (h) i (j k) l))`, sharedEnv), 
    ...
    test(`QUOTE: unquote defeats quasiquoteexpand in battle`, () => {
        assertEquals(rep(`(quasiquoteexpand (unquote 7))`, sharedEnv), 
        // 7
        printString(new NumberNode(7), true));
    });
    ...
    test(`QUOTE: quasiquoteexpand expands an unquoted symbol into the symbol`, () => {
        assertEquals(rep(`(quasiquoteexpand (unquote a))`, sharedEnv), 
        // a
        printString(new SymbolNode('a'), true));
    });
    test(`QUOTE: quasiquoteexpand expands a mixed list into conses and quotes`, () => {
        assertEquals(rep(`(quasiquoteexpand (1 a 3))`, sharedEnv), 
    ...
    test(`QUOTE: quasiquoteexpand expands into conses and unquotes symbols `, () => {
        assertEquals(rep(`(quasiquoteexpand (1 (unquote a) 3))`, sharedEnv), 
    ...
    test(`QUOTE: quasiquoteexpand is still consing and quoting`, () => {
        assertEquals(rep(`(quasiquoteexpand (1 b 3))`, sharedEnv), 
    ...
    test(`QUOTE: unquote within quasiquoteexpand doesn't evaluate the symbols`, () => {
        assertEquals(rep(`(quasiquoteexpand (1 (unquote b) 3))`, sharedEnv), 
    ...
    test(`QUOTE: quasiquoteexpand expands lists of unquotes into conses`, () => {
        assertEquals(rep(`(quasiquoteexpand ((unquote 1) (unquote 2)))`, sharedEnv), 
        // (cons 1 (cons 2 ()))
        printString(new ListNode([
            new SymbolNode('cons'),
            new NumberNode(1),
    ...
    test(`QUOTE: quasiquoteexpand expands splice-unquote into concat expressions`, () => {
        assertEquals(rep(`(quasiquoteexpand (a (splice-unquote (b c)) d))`, sharedEnv), 
    ...
    test(`QUOTE: quasiquoteexpand is still doing its thang`, () => {
        assertEquals(rep(`(quasiquoteexpand (1 c 3))`, sharedEnv), 
    ...
    test(`QUOTE: splice-unquote within a quasiquoted list expands to concat`, () => {
        assertEquals(rep(`(quasiquoteexpand (1 (splice-unquote c) 3))`, sharedEnv), 
    ...
    test(`QUOTE: splice-unquote within a quasiquoted list expands to concat and does not evaluate variables`, () => {
        assertEquals(rep(`(quasiquoteexpand (1 (splice-unquote c)))`, sharedEnv), 
        // (cons 1 (concat c ()))
        printString(new ListNode([
            new SymbolNode('cons'),
            new NumberNode(1),
    ...
    test(`QUOTE: splice-unquote within a quasiquoted list expands to concat, and numbers to cons`, () => {
        assertEquals(rep(`(quasiquoteexpand ((splice-unquote c) 2))`, sharedEnv), 
        // (concat c (cons 2 ()))
        printString(new ListNode([
            new SymbolNode('concat'),
            new SymbolNode('c'),
    ...
    test(`QUOTE: splice-unquoting the same symbol multiple times within a quasiquoted list expands all to concat`, () => {
        assertEquals(rep(`(quasiquoteexpand ((splice-unquote c) (splice-unquote c)))`, sharedEnv), 
        // (concat c (concat c ()))
        printString(new ListNode([
            new SymbolNode('concat'),
            new SymbolNode('c'),
