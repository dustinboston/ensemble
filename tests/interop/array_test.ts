...
Deno.test('ARRAY INTEROP: Array constructor', () => {
  assertEquals(rep('(Array 1 2 3)', replEnv), '[1 2 3]');
});

Deno.test('ARRAY INTEROP: Array.from with vector', () => {
  assertEquals(rep('(Array.from [1 2 3])', replEnv), '[1 2 3]');
});

Deno.test('ARRAY INTEROP: Array.from with vector and mapping function', () => {
  assertEquals(rep('(Array.from [1 2 3] (function (x) (* x 2)))', replEnv), '[2 4 6]');
});

// TODO: Deno.test('ARRAY INTEROP: Array.from with vector, mapping function, and thisArg', () => {
//   assertEquals(
