...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.apply'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.apply"');
    } catch (e) {
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.bind'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.bind"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.call'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        const thisArg = types.toJs<types.AstNode>(astArgs[0]);
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.call"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array[Symbol.hasInstance]'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array[Symbol.hasInstance]"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.toString'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.toString"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.length'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.length"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.name'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.name"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.toLocaleString'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.toLocaleString"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.valueOf'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.valueOf"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.constructor'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.constructor"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.new'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.new"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.from'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length === 1) && types.isVectorNode(astArgs[0]) && types.isTypedVector(astArgs[0], types.NumberNode)
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.from"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.BYTES_PER_ELEMENT'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.BYTES_PER_ELEMENT"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.at'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.at"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.copyWithin'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.copyWithin"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.entries'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.entries"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.every'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.every"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.fill'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.fill"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.filter'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.filter"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.find'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.find"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.findIndex'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.findIndex"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.findLast'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.findLast"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.findLastIndex'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) &&
      ...
      return types.createErrorNode(
        types.createStringNode('Invalid arguments to "Float64Array.prototype.findLastIndex"'),
      );
    } catch (e) {
      return types.toErrorNode(e);
    }
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.forEach'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.forEach"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.includes'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.includes"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.indexOf'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) && types.isAstNode(astArgs[1]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.indexOf"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.join'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.join"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.keys'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.keys"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.lastIndexOf'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) && types.isNumberNode(astArgs[1]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.lastIndexOf"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.map'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.map"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.reduce'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.reduce"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.reduceRight'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 2) && types.isAstNode(astArgs[0]) && types.isFunctionNode(astArgs[1])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.reduceRight"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.reverse'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.reverse"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.set'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.set"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.slice'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.slice"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.some'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.some"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.sort'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.sort"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.subarray'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 1 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) && types.isNumberNode(astArgs[1]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.subarray"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype[Symbol.iterator]'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode(
        types.createStringNode('Invalid arguments to "Float64Array.prototype[Symbol.iterator]"'),
      );
    } catch (e) {
      return types.toErrorNode(e);
    }
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.toLocaleString'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode(
        types.createStringNode('Invalid arguments to "Float64Array.prototype.toLocaleString"'),
      );
    } catch (e) {
      return types.toErrorNode(e);
    }
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.toReversed'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.toReversed"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.toSorted'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 1 && astArgs.length <= 2) && types.isAstNode(astArgs[0]) && types.isFunctionNode(astArgs[1])
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.toSorted"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.valueOf'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.valueOf"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.values'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.values"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.with'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.with"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.buffer'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.buffer"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.byteLength'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.byteLength"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.byteOffset'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.byteOffset"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float64Array.prototype.length'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float64Array.prototype.length"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
