...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.apply'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.apply"');
    } catch (e) {
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.bind'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.bind"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.call'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        const thisArg = types.toJs<types.AstNode>(astArgs[0]);
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.call"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array[Symbol.hasInstance]'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array[Symbol.hasInstance]"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.toString'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.toString"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.length'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.length"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.name'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.name"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.toLocaleString'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.toLocaleString"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.valueOf'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.valueOf"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.constructor'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.constructor"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.new'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.new"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.from'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length === 1) && types.isVectorNode(astArgs[0]) && types.isTypedVector(astArgs[0], types.NumberNode)
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.from"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.BYTES_PER_ELEMENT'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 0)) {
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.BYTES_PER_ELEMENT"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.at'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.at"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.copyWithin'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.copyWithin"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.entries'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.entries"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.every'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.every"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.fill'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.fill"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.filter'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.filter"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.find'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.find"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.findIndex'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.findIndex"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.findLast'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.findLast"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.findLastIndex'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) &&
      ...
      return types.createErrorNode(
        types.createStringNode('Invalid arguments to "Float32Array.prototype.findLastIndex"'),
      );
    } catch (e) {
      return types.toErrorNode(e);
    }
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.forEach'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.forEach"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.includes'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.includes"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.indexOf'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) && types.isAstNode(astArgs[1]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.indexOf"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.join'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.join"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.keys'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.keys"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.lastIndexOf'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) && types.isNumberNode(astArgs[1]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.lastIndexOf"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.map'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.map"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.reduce'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.reduce"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.reduceRight'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 2) && types.isAstNode(astArgs[0]) && types.isFunctionNode(astArgs[1])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.reduceRight"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.reverse'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.reverse"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.set'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.set"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.slice'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.slice"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.some'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 2 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.some"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.sort'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.sort"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.subarray'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 1 && astArgs.length <= 3) && types.isAstNode(astArgs[0]) && types.isNumberNode(astArgs[1]) &&
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.subarray"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype[Symbol.iterator]'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode(
        types.createStringNode('Invalid arguments to "Float32Array.prototype[Symbol.iterator]"'),
      );
    } catch (e) {
      return types.toErrorNode(e);
    }
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.toLocaleString'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode(
        types.createStringNode('Invalid arguments to "Float32Array.prototype.toLocaleString"'),
      );
    } catch (e) {
      return types.toErrorNode(e);
    }
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.toReversed'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.toReversed"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.toSorted'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
        (astArgs.length >= 1 && astArgs.length <= 2) && types.isAstNode(astArgs[0]) && types.isFunctionNode(astArgs[1])
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.toSorted"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.valueOf'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.valueOf"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.values'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.values"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.with'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if (
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.with"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.buffer'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.buffer"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.byteLength'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.byteLength"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.byteOffset'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.byteOffset"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
...
javascriptNamespace.set(
  types.createSymbolNode('Float32Array.prototype.length'),
  types.createFunctionNode((...astArgs: types.AstNode[]): types.AstNode => {
    try {
      if ((astArgs.length === 1) && types.isAstNode(astArgs[0])) {
        /* context */
      ...
      return types.createErrorNode('Invalid arguments to "Float32Array.prototype.length"');
    } catch (e) {
      return types.toErrorNode(e);
    }
  }),
